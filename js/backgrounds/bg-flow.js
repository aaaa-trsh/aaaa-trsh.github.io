...
function drawParticle(x, y, i) {
    ...
    var addX = lerp(attractor[0]*-2, noiseAngle[0], clicking ? clamp(mix, 0, 1) : 1)*cellSpeed * noiseValue * 3;//*(clamp(mix, .3, 2))
    var addY = lerp(attractor[1]*-2, noiseAngle[1], clicking ? clamp(mix, 0, 1) : 1)*cellSpeed * noiseValue * 3;//*(clamp(mix, .3, 2))
